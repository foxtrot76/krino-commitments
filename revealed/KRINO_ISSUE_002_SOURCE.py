#!/usr/bin/env python3
# KRINO WEEKLY ISSUE No002 — CONTENT block (locked 4-page design inherited from 001 verbatim)
CONTENT = {
  "out": "/home/claude/krino/publication/KRINO_WEEKLY_No002.pdf",
  "issue_no": "002", "date": "2026-07-18", "specimen": False,
  "publisher": "KRINO — published by A.G.", "data_cutoff": "markets 2026-07-16/17 · inflation June 2026",
  "asof": "2026-07-18 22:30 CET", "reading_time": "≈ 4 minutes",
  "commit_url": "github.com/foxtrot76/krino-commitments", "intake_email": "krino.reviews@gmail.com",

  # PAGE 1 — THE RECORD
  "headline": "The inflation print cooled and sentiment rebounded; oil, semiconductors, and the 30-year yield moved the other way.",
  "state_pair": [("Stress","CALM",False),("Inflation","WATCH",True)],
  "evidence_strength": "Low",
  "state_note": "inflation regime WATCH since 2026-03 — third live reading",
  "read": ("Market-stress regime unchanged and calm: equity volatility 16.7, the yield curve at +0.37, credit "
           "spreads tight, jobless claims 208,000. June consumer prices fell 0.35% on the month — the headline "
           "rate declined from 4.25% to 3.53% year-over-year, energy-led — and consumer sentiment rose to a "
           "five-month high of 54.4. On those readings the scored panel softened to its weakest reading since "
           "this report began. The opposite-direction readings were unscored: tanker transit through the Strait "
           "of Hormuz fell sharply after fighting resumed, Brent crude rose about ten percent to $81.6, the "
           "semiconductor index fell 10.0% on the week, and gold declined alongside equities while the 30-year "
           "Treasury yield rose through 5.09% — safe-haven flows did not go to government bonds. A pre-registered "
           "wage-squeeze rule completed its scheduled June test and did not fire. Between scheduled releases the "
           "published state moves only on the pre-registered falsifiers below — headlines and commentary, "
           "including this report's own, change nothing by themselves."),
  "sh_stress":    ['C','C','C','C','C','C','C','C','C','C','C','C','C'],
  "sh_inflation": ['N','N','N','N','N','N','N','N','W','W','W','W','W'],
  "sh_end": "2026-07",
  "forward_tests": [("Labour-slack sign","reg. 2026-06-23","grades 2026-08-07","in 20 days"),
                    ("Wage-squeeze rule (June pair)","reg. 2026-07-11","GRADED 2026-07-14: did not fire","re-arms at the August print"),
  ...
  # PAGE 2 — THE THESIS
  "thesis_active": ("A calm market-stress regime coincident with an inflation axis at WATCH — and, this period, a "
      "divergence between what is scored and what is observed. The scored panel softened: the June price print "
      "declined, sentiment rebounded from its record low, claims stayed near cycle lows. The observed-but-unscored "
      "channels hardened: chokepoint transit constrained with crude repricing higher, a second sharp semiconductor "
      "decline in four weeks, and a week in which neither gold nor Treasuries behaved as havens. The stress panel "
      "is, by construction, tuned to deflationary and liquidity stress; the divergence is carried by the "
      "separately monitored energy and awareness channels. Published state moves only on a pre-registered "
      "falsifier — none was met this period."),
  "thesis_opposing": ("Each adverse observation has a benign competing explanation with a scheduled test. The June "
      "price decline was energy-led and broad: if the spring energy spike keeps rolling out of the three-month "
      "window, the inflation axis's acceleration condition fails at the August print and WATCH can resolve back "
      "to NONE — the axis's first live episode ending as a false positive would itself be recorded. Crude has "
      "round-tripped on this conflict twice before; transit data, not price, is the discriminator. The "
      "semiconductor decline matches an April correction that mean-reverted. And the sentiment rebound plus low "
      "claims read as a consumer stabilising, not deteriorating."),
  "rejected": [["Alternative","Rejected because"],
      ["Acute market-stress regime","Volatility 16.7, curve +0.37, credit benign — no scored stress"],
      ["Inflation regime confirmed","Two of six qualifying months; June printed 3.53%, below the 4% bar"],
      ["All-clear / watch retired","Chokepoint transit constrained, crude +10% on the week; the panel softened — it did not invert"]],
  "panel": [["Signal","Reading","Threshold","Status"],
      ["Equity volatility (VIX)","16.73","< 20","calm"],["S&P 500","7,458","—","−1.6% on week"],
      ["Yield curve (10y − 2y)","+0.37","> 0","positive"],["High-yield credit spread","1.10 divergence","< 1.44","benign"],
      ["Initial jobless claims","208,000","< 300k","low"],["Market-stress index","MILD (~35th pctile)","—","below bands"]],
  "irs": [["Component","Value","Threshold","Fires"],
      ["CPI, year-over-year","3.53%","≥ 3%","yes"],["CPI, 3-month annualised","4.61%","≥ year-over-year rate","yes"],
      ["Months ≥ 4% year-over-year","2 of 6","6 to arm","no"],["Real policy rate","≈ +0.1%","≤ −1.0%","no"],
  ...
  "blindspots": ("Commodity and energy supply shocks are monitored but not scored — this week is a live example: "
      "the largest moves of the period sit in the monitored, not the scored, column. The stress panel is "
      "structurally insensitive to inflationary regimes; that gap is partially covered by the inflation-regime "
      "axis. Private-credit stress is not visible in public spreads and is watched, not scored."),
  ...
  "reviews": [("OpenAI","architecture review","recommended additional verification gates before any scoring rule is archived; adopted."),
              ("DeepSeek","architecture review","required a reference-integrity screen and an uncertainty routing state; both adopted.")],
  ...
  "strongest_challenge": ("The inflation-regime axis is live but unvalidated, and this week sharpened the question: "
      "its acceleration condition now holds only through the spring energy spike still inside the three-month "
      "window. If the August print rolls that spike out and the condition fails, the first live WATCH ends as a "
      "recorded false positive. Open — adjudication continues at the August and September prints."),
